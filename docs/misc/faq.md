...
See [this example project](https://github.com/garden-io/garden/tree/v0.11.16/examples/base-image).
...
No. If you have multiple modules that use the same Dockerfile, you should instead have a single base image and then let each module have its own Dockerfile that's built on the base image. See the [base image example project](https://github.com/garden-io/garden/tree/v0.11.16/examples/base-image) for an example of this.

### How do I include files/dirs (e.g. shared libraries) from outside the module root with the build context?

See [this example project](https://github.com/garden-io/garden/tree/v0.11.16/examples/build-dependencies).
...
See also the [base image example project](https://github.com/garden-io/garden/tree/v0.11.16/examples/base-image) for an example of this.
