...
In this guide we'll be using the [vote-helm](https://github.com/garden-io/garden/tree/v0.11.16/examples/vote-helm) project. If you prefer to just check out a complete example, the project itself is also a good resource.
...
_[kubernetes-module](https://github.com/garden-io/garden/tree/v0.11.16/examples/kubernetes-module) example for more info._
...
Check out the full [helm module reference](../reference/module-types/helm.md) for more details, and the [vote-helm](https://github.com/garden-io/garden/tree/v0.11.16/examples/vote-helm) example project for a full project that showcases Garden's Helm support.

Also check out the [kubernetes-module](https://github.com/garden-io/garden/tree/v0.11.16/examples/kubernetes-module)
